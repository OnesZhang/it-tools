...
import { ChartCircles, Home2, Menu2 } from '@vicons/tabler';
    ...
    <template #content>
      <div flex items-center justify-center gap-2>
        ...
        <c-tooltip position="bottom" :tooltip="$t('home.support')">
          <c-button round href="https://huahan.cc" rel="noopener" target="_blank" class="support-button" :bordered="false"
            @click="() => tracker.trackEvent({ eventName: 'Support button clicked' })">
            {{ $t('home.GoHuahan') }}
            <NIcon v-if="!styleStore.isSmallScreen" :component="ChartCircles" ml-2 />
          </c-button>
        </c-tooltip>
      </div>
      <slot />
